...
urlpatterns = [
    ...
    path("views/<int:year>/", getYearlyViews, name="admin-views-year"),
    path(
        "views/<int:year>/<int:id>/",
        getYearlyViewsPerBook,
        name="admin-views-year-book",
    ),
    path("views/<int:year>/<int:month>/", getMonthlyViews, name="admin-views-month"),
    path(
        "views/<int:year>/<int:month>/<int:id>/",
        getMonthlyViewsPerBook,
